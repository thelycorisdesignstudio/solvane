...
app.use('/api/auth',authRoutes);app.use('/api/documents',docRoutes);app.use('/api/ai',aiRoutes);app.use('/api/signatures',signRoutes);app.use('/api/automation',autoRoutes);app.use('/api/tools',toolRoutes);app.use('/api/share',shareRoutes);app.use('/api/team',teamRoutes);
