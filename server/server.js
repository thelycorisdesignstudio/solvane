...
import authRoutes from './routes/auth.js';import docRoutes from './routes/documents.js';import aiRoutes from './routes/ai.js';import signRoutes from './routes/signatures.js';import autoRoutes from './routes/automation.js';
...
app.use('/api/auth',authRoutes);app.use('/api/documents',docRoutes);app.use('/api/ai',aiRoutes);app.use('/api/signatures',signRoutes);app.use('/api/automation',autoRoutes);
